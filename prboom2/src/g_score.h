...
typedef enum {
    ...
    SCORE_EVT_ENEMY_OVERKILL,
    SCORE_EVT_ZOMBIE_DAMAGED,
    SCORE_EVT_PLAYER_DAMAGED,
    SCORE_EVT_ITEM_GOT,
    SCORE_EVT_NONCOUNTABLE_ITEM_GOT,
    SCORE_EVT_SPECIAL_ITEM_GOT,
    SCORE_EVT_SECRET_FOUND,
    SCORE_EVT_STREAK_TIMEOUT,
    SCORE_EVT_LEVEL_DONE,
    SCORE_EVT_100P_ITEMS,
    SCORE_EVT_100P_SECRETS,
    SCORE_EVT_100P_KILLS,
    SCORE_EVT_100P_MAX,
    SCORE_EVT_LAST
} g_score_event_t;
...
typedef enum {
    ...
    SCORE_CFG_ITEM_POINTS,
    SCORE_CFG_SPECIAL_ITEM_POINTS,
    SCORE_CFG_OVERKILL_POINTS,
    SCORE_CFG_100P_ITEMS,
    SCORE_CFG_100P_SECRETS,
    SCORE_CFG_100P_KILLS,
    SCORE_CFG_100P_MAX,
    SCORE_CFG_LAST
} g_score_config_t;
